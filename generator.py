...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/Users/bekhruzmd/Desktop/flash-gen/gemini_key.json"
...
def main():
    ...
    llm  = VertexAI(model_name="gemini-1.5-pro-preview", temperature=0.3)
